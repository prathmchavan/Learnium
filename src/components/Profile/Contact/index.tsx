                    ...
                    <h2 className="font-bold text-xl text-neutral-200">Contact Section</h2>
                        ...
                        <form className="my-8" onSubmit={handleSubmit}>
                            ...
                            <LabelInputContainer className="mb-4">
                                ...
                                <Input id="email" name="email" placeholder={user?.contact.email} type="text" className=" placeholder:text-white" />
                            </LabelInputContainer>
                            <LabelInputContainer className="mb-4">
                                <Label htmlFor="phone">Phone no.</Label>
                                <Input id="phone" name="phone" placeholder={user?.contact.phone} type="text" className=" placeholder:text-white" />
                            </LabelInputContainer>
                            <LabelInputContainer className="mb-4" >
                                <Label htmlFor="password">Update Password</Label>
                                <Input id="password" name="password" placeholder="•••••••••••" type="password" className=" placeholder:text-red-500 " />
                            </LabelInputContainer>
