...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4  bg-[#0B0121] border border-[#22066F] flex flex-col justify-between space-y-4",
        className
      )}
    >
