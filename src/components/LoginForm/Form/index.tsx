...
export function Form() {
  const { login, signup, handleChange } = useAuthContext();
      ...
      <div className="flex justify-center ">
        <BackgroundGradient className="rounded-[22px] max-w-md p-4 sm:p-10 bg-zinc-900 w-[500px] md:rounded-2xl md:p-8 shadow-input" containerClassName=" w-auto">
          ...
          <p className="text-sm max-w-sm mt-2 text-neutral-300">
            Already Have One{" "}
            <LinkPreview url="/login" className="font-bold text-purple-300" imageSrc="/images/login.png" isStatic={true}>
              Log In
            </LinkPreview>
          </p>
      ...
      <div className="flex justify-center">
        <BackgroundGradient className="rounded-[22px] max-w-md p-4 sm:p-10 bg-zinc-900 w-full md:rounded-2xl md:p-8 shadow-input" containerClassName="max-w-md">
          ...
          <p className="text-sm max-w-sm mt-2 text-neutral-300">
            ...
            <LinkPreview url="/signup" className="font-bold text-purple-300" imageSrc="/images/signup.png" isStatic={true}>
              Create One
            </LinkPreview>
          </p>
          <form className="my-8" onSubmit={handleSubmit}>
